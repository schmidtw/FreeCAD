...
if not hasattr(Gui, 'Selection'):
    Gui.Selection = type('MockSelection', (), {
...
class TestCommandInsertLink(unittest.TestCase):
    ...
    def test_mixed_valid_and_invalid_objects(self):
        ...
        test_objects = [
            ...
            {
                'addedObject': type('ValidObject', (), {
                    'Name': 'ValidObject',
                    'Label': 'Valid Object',
                    'LinkedObject': type('ValidLinkedObject', (), {
                        'Name': 'ValidLinkedObjectName'
                    })()
                })(),
            ...
            {
                'addedObject': type('InvalidObject1', (), {
                    'Name': 'InvalidObject1',
                    'Label': 'Invalid Object 1',
                    'LinkedObject': None
                })(),
            ...
            {
                'addedObject': type('InvalidObject2', (), {
                    'Name': 'InvalidObject2',
                    'Label': 'Invalid Object 2'
                })(),
                'translation': App.Vector(3, 3, 3)
            },
            # Invalid: LinkedObject.Name is None
            {
                'addedObject': type('InvalidObject3', (), {
                    'Name': 'InvalidObject3',
                    'Label': 'Invalid Object 3',
                    'LinkedObject': type('LinkedObjectWithNoneName', (), {
                        'Name': None
                    })()
                })(),
            ...
            {
                'addedObject': type('InvalidObject4', (), {
